"""Pytest fixtures for SaaS persistence integration tests.
...
def db_session(_app_engine, super_db_session):
    ...
    The fixture depends on super_db_session to ensure the outer transaction
    (rollback) wraps both sessions when tests modify shared catalog data.
    """
